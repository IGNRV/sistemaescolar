...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['amount'])) {
    ...
    try {
        $opts = array(
            ...
            "return_url" => "http://sistemaescolar.oralisisdataservice.cl/khipu/retorno.php",
            "cancel_url" => "http://sistemaescolar.oralisisdataservice.cl/khipu/cancelado.php",
            "notify_url" => "http://sistemaescolar.oralisisdataservice.cl/khipu/notificacion.php"
        );
...
// Muestra un formulario simple para iniciar el proceso de pago
?>
